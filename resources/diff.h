...
#define MN1(  left , right )              New_dCell(dTree, dT_operator, "-1", left, right)
#define AD1(  left , right )              New_dCell(dTree, dT_operator, "1", left, right)
...
DIFF_( ^     , dT_operator, MUL( POV( l, r), ADD( MUL( LN( l, NULL), dr), DIV( l, r))) )
